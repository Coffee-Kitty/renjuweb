...
window.onload=function(){
    ...
    human_player.name=getCookie('name');
    if (getCookie('name')!==getCookie('player2')){
         botPlayer.name=getCookie('player2');

    }else{
         botPlayer.name=getCookie('player1');
         isBlack=false;
    }
    human_player.game_id=getCookie('game_id');
    botPlayer.game_id=getCookie('game_id');
